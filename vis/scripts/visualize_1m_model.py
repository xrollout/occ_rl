"""
Visualize episodes from the 1M step trained model.
"""
import os
import sys
import torch
...
def plot_episode(result, episode_num, save_path=None):
    ...
    ax1.set_title('Robot Trajectory (1M Step Model)', fontsize=12, fontweight='bold')
...
def main():
    checkpoint_path = './output/ppo_training_output_1m/checkpoint_1001472.pt'
    output_dir = './visualizations_1m'
    device = 'cpu'
    n_episodes = 5
    ...
    print('=' * 80)
    print('VISUALIZING 1M STEP PPO POLICY')
    print('=' * 80)
