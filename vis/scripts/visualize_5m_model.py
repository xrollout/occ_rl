"""
Visualize episodes from the 5M step trained model.
"""
import os
import sys
import torch
...
def plot_episode(result, episode_num, save_path=None):
    ...
    ax1.set_title('Robot Trajectory (5M Step Model)', fontsize=12, fontweight='bold')
...
def main():
    ...
    print('=' * 80)
    print('VISUALIZING 5M STEP PPO POLICY')
    print('=' * 80)
    ...
    for i in range(n_episodes):
        ...
        result = run_episode(env, policy, seed=i+3000, deterministic=True, device=device)
