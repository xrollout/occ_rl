"""
Visualize episodes from the 300k step trained model.
"""
import os
import sys
import torch
...
def plot_episode(result, episode_num, save_path=None):
    ...
    ax1.set_title('Robot Trajectory (300k Step Model)', fontsize=12, fontweight='bold')
...
def main():
    ...
    output_dir = './visualizations_300k'
    device = 'cpu'
    n_episodes = 5
    ...
    print('=' * 80)
    print('VISUALIZING 300K STEP PPO POLICY')
    print('=' * 80)
