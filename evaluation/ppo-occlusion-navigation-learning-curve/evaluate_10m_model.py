"""
Evaluate 10M step model success rate over 100 episodes.
"""
import os
import sys
import torch
...
def main():
    ...
    print('=' * 80)
    print('EVALUATING 10M STEP MODEL')
    print('=' * 80)
    ...
    print()
    print('=' * 80)
    print('FINAL RESULTS (10M Step Model)')
    print('=' * 80)
    print(f'Total timesteps trained: 10,004,480')
    ...
    with open('./output/evaluation_results/10m_model_results.txt', 'w') as f:
        f.write(f'Total timesteps: 10,004,480\n')
