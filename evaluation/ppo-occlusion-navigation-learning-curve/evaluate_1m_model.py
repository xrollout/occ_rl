"""
Evaluate 1M step model success rate over 100 episodes.
"""
import os
import sys
import torch
...
def main():
    checkpoint_path = './ppo_training_output_1m/checkpoint_1001472.pt'
    device = 'cpu'
    n_episodes = 100

    print('=' * 80)
    print('EVALUATING 1M STEP MODEL')
    print('=' * 80)
    ...
    print()
    print('=' * 80)
    print('FINAL RESULTS (1M Step Model)')
    print('=' * 80)
    ...
    with open('./evaluation_results/1m_model_results.txt', 'w') as f:
        f.write(f'Total timesteps: 1,001,472\n')
